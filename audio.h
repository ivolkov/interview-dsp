...
#define AUDIO_SOFT_BUF_SIZE_FRAMES	(audio_period_size_frames * AUDIO_CHANNELS)

/* software buffer size in bytes */
#define AUDIO_SOFT_BUF_SIZE_BYTES	(AUDIO_SOFT_BUF_SIZE_FRAMES * AUDIO_FRAME_SIZE_BYTES)
